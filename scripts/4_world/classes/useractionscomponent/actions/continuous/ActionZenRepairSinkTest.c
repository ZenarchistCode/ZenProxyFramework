...
class ActionZenRepairSinkTest : ActionContinuousBase
{
	...
	override void OnFinishProgressServer(ActionData action_data)
	{
		...
		ZenProxySinkTest sinkProxyObj = ZenProxySinkTest.Cast(g_Game.CreateObjectEx("ZenProxySinkTest", proxyTargetWS, ECE_FULL));
		if (sinkProxyObj)
		{
	...
	override void OnStartAnimationLoop(ActionData action_data)
	{
		...
		g_Game.RPCSingleParam(action_data.m_MainItem, ERPCs.RPC_SOUND_LOCK_ATTACH, play, true);
	}
