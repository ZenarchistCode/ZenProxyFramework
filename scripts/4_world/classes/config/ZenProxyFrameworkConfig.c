class ZenProxyFrameworkConfig
{
	...
	void Load()
	{
		string mapNameLocal = g_Game.GetWorldName();
	...
	{
		if (OverrideHouseProxyData.Count() == 1 && OverrideHouseProxyData.Get(0).HouseConfigType == "Example_Building_Name")
			return NULL;
